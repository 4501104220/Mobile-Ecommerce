...
import com.dev.mobile_ecommerce.allproductmodel.AllProduct;
import com.dev.mobile_ecommerce.allproductmodel.ImagesModel;
import com.dev.mobile_ecommerce.productdetail.ProductDetailsActivity;

import java.util.List;


public class AllProductAdapter extends RecyclerView.Adapter<com.dev.mobile_ecommerce.womenselection.AllProductAdapter.ViewHolder> {
    ...
    @Override
    public com.dev.mobile_ecommerce.womenselection.AllProductAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(com.dev.mobile_ecommerce.womenselection.AllProductAdapter.ViewHolder viewHolder, int i) {
